...
///
/// Zap: cloud ambient-agent environment/setup-status display was removed along with the
/// cloud ambient-agent UI subsystem (see Zap Wave 7-3); this always resolves from the
