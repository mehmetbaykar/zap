...
pub enum LeftPanelEvent {
    ...
    /// A remote file-tree image was clicked; the main window should open it in the image viewer.
    #[cfg_attr(not(feature = "local_tty"), allow(dead_code))]
    OpenRemoteImage {
        remote_path: crate::code::buffer_location::RemotePath,
    },
            ...
            GlobalSearchViewEvent::OpenMatch {
                ...
                ctx.emit(LeftPanelEvent::OpenFileWithTarget {
                    location: match location {
                        ...
                        LocalOrRemotePath::Remote(remote) => {
                            BufferLocation::Remote(crate::code::buffer_location::RemotePath::new(
