...
impl WorkflowModal {
    /// Generates metadata for a command via a BYOP one-shot completion, and applies the AI
    /// feedback directly into the corresponding fields of the modal editor. No BYOP config → emit an error event directly.
