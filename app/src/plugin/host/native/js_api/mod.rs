...
/// Returns a JS object representing the Zap Plugin API exposed to external JavaScript plugins.
///
...
/// Returns a JS object representing the Completions namespace for the Zap Plugin API.
///
/// API methods:
///
