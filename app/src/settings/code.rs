...
define_settings_group!(CodeSettings, settings: [
    ...
    auto_save: AutoSave {
        type: bool,
        // Zap: upstream defaults this off; the fork's previous autosave
        // (`code.editor.autosave`, now superseded) shipped on-by-default, so
        // keep that behavior.
        default: true,
        supported_platforms: SupportedPlatforms::ALL,
        sync_to_cloud: SyncToCloud::Globally(RespectUserSyncSetting::Yes),
        ...
        description: "Whether the Zap text editor automatically saves changes as you type and when the editor loses focus.",
    },
]);
