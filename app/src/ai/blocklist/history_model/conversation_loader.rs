...
///
/// The specific format depends on the agent harness that generated the conversation.
pub enum LoadedConversationData {
    /// A conversation generated by the Oz harness, restorable into the [`AIConversation`] data model.
    Oz(Box<AIConversation>),
    /// A conversation generated by an external CLI agent harness.
