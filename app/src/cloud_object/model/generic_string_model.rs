...
pub trait StoredStringObject: StoredObject + Send + Sync {
    ...
    /// We can't require this trait to derive Clone directly, otherwise the trait is no longer object
    /// safe.
...
/// can reuse most of the local object-store behavior by implementing this trait.
///
