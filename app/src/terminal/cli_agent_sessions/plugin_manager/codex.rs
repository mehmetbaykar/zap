...
static PLUGIN_INSTALL_INSTRUCTIONS: LazyLock<PluginInstructions> =
    LazyLock::new(|| PluginInstructions {
        title: "Install Zap Plugin for Codex",
...
static NATIVE_INSTALL_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| {
    PluginInstructions {
        title: "Enable Zap Notifications for Codex",
        subtitle: "Update Codex to the latest version, then enable in-focus notifications so Zap can display them while you work.",
        steps: vec![
...
static PLUGIN_UPDATE_INSTRUCTIONS: LazyLock<PluginInstructions> = LazyLock::new(|| {
    PluginInstructions {
        title: "Update Zap Plugin for Codex",
        subtitle: "Run the following command, then restart Codex.",
        steps: vec![PluginInstructionStep {
