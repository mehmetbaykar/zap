...
impl SystemInfo {
    ...
    /// freed moments later is skipped instead of producing a worthless report and heap profile.  A
    /// skip does not consume `has_emitted_memory_warning_event`, so an early transient spike
