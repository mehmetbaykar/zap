...
use crate::code::buffer_location::BufferLocation as BufferFileLocation;
...
impl LocalCodeEditorView {
    ...
    {
        Self::new_with_buffer_location(
            BufferFileLocation::Local(path.to_path_buf()),
            editor_constructor,
            enable_diff_nav_by_default,
            display_mode,
            ctx,
    ...
    /// Construct an editor view with a shared buffer backed by the given location.
    ///
    ...
    pub fn file_path(&self) -> Option<&Path> {
        self.file_location()
            .and_then(BufferFileLocation::local_path)
    }
