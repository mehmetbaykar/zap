...
// Zap (localization, Phase 2d-4a-1): the original `assert_websocket_has_started` /
// `assert_websocket_has_not_started` assertions depended on the physically deleted `Listener`
// singleton; they have no callers and were removed along with it.
