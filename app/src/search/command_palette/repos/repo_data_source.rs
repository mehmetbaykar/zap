...
// Zap: WorkspaceMetadata lives in the fork's persisted_workspace module (upstream
// moved it to the `ai` crate), and recency is `most_recently_touched` here.
use crate::ai::persisted_workspace::{PersistedWorkspace, WorkspaceMetadata};
