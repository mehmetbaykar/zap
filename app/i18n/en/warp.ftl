...
ai-document-save-and-sync-tooltip = Automatically save this plan to your Zap Drive (stored locally)
...
terminal-input-queue-agent-hint = Queue a follow up for the running agent
terminal-input-queue-agent-backspace-hint = Queue a follow up for the running agent, or backspace to exit
...
settings-exec-profile-editor-context-window = Context window
settings-exec-profile-editor-context-window-desc = The base model's working memory — how many tokens of your conversation, code, and documents it can consider at once. Larger windows enable longer conversations and more coherent responses over bigger codebases, at the cost of higher latency and compute usage.
...
toggle-suffix-outline-codebase-symbols = codebase symbols in the '@' context menu
