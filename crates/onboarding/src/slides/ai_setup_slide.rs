...
/// Forks between Zap's built-in local agent experience and third-party CLI agents.
...
impl AiSetupSlide {
    ...
    // Reuse bundled assets that match the built-in agent and CLI-agent choices.
    ...
    fn render_header(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let subtitle = FormattedTextElement::from_str(
            "Choose if you'd like to use Zap Agent or third-party agents.",
