...
//! Zap, so users can "plug in" their subscription instead of pasting a
...
//! at xAI's token endpoint. Callers are responsible for secure local token
//! persistence and provider-direct request routing; this module never packages
...
<title>Zap — Grok connected</title></head>\
<body style=\"font-family:system-ui,-apple-system,sans-serif;text-align:center;padding:3rem\">\
<h1>Grok connected</h1><p>You can close this window and return to Zap.</p></body></html>";

const FAILURE_HTML: &str = "<!doctype html><html><head><meta charset=\"utf-8\">\
<title>Zap — Grok authorization failed</title></head>\
<body style=\"font-family:system-ui,-apple-system,sans-serif;text-align:center;padding:3rem\">\
<h1>Authorization failed</h1><p>Something went wrong. Return to Zap and try again.</p></body></html>";
