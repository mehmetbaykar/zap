...
Upstream sync state (2026-07-11 — MERGE ERA, see SPEC.md):
...
- Next: slice 3 = `a44b70306..09be9c1ff` (2026-06-15 boundary). This slice introduces `crates/warp_tui`; keep it a non-default workspace member and add `cargo check -p warp_tui` to every subsequent gate.
