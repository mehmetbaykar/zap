...
Upstream sync state (2026-07-13 — MERGE ERA, see SPEC.md):
...
- Next: slice 4 = `09be9c1ff..474cf6b0`. Repository ancestry confirms `crates/warp_tui` first arrives in slice 5 (`474cf6b0..1c376cb0f`), where it becomes a non-default workspace member and adds `cargo check -p warp_tui` to every subsequent gate.
