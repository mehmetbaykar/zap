...
- Next: slice 5 = `474cf6b0..1c376cb0f`. Repository ancestry confirms `crates/warp_tui` arrives in this slice as a non-default workspace member, adding `cargo check -p warp_tui` to every subsequent gate.
